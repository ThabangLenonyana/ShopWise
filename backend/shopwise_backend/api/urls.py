...
from .views import ProductListView, ProductDetailView, CategoryListView, RetailerListView, RetailerDetailView, ProductsCompareView, FavoriteToggleView, ProductRecommendationView
